...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Hello Diệu!";
    let charArrTitle = textTitle.split('');
let text = "Daika lúc nào cũng không thích giống những người khác nên mới nghĩ ra cách này để decor cây thông của em haha. Chắc là không trùng idea với ai nữa đâu nhỉ, không thì khó chịu lắmmmmmm. Anyway, chúc em có 1 mùa giáng sinh thật an lành, ấm áp và hạnh phúc bên những người thân yêu nhé! À chắc cũng đang bận ôn thi hết học phần nhỉ, chúc em kết thúc kỳ học đầu tiên ở ngôi trường mới này với full A+ nhé, luv u <3 -Dungdaika-"
